...
# from apps.newProduct import views as new
from apps.product import views

urlpatterns = [
    path('collections/<int:pk>/', views.CollectionView.as_view(), name='collections'),
    path('search/', views.search, name='search'),
    path('product/<int:pk>/review/', ReviewView.as_view(), name='product_review'),
    path('product/<int:pk>/wishlist-add/', views.WishListAddView.as_view(), name='wishlist-add'),
    # path('product/<int:pk>/wishlist-remove', views.WishListRemoveView.as_view(), name='wishlist-remove'),
    path('product/<int:pk>/compare/', views.CompareView.as_view(), name='product-compare'),
    path('product/comparing/', views.ComparingView.as_view(), name='product-comparing'),
    path(
